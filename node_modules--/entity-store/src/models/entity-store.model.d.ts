...
export interface EntityStore<TEntityTypeMap extends EntityTypeMap, TStoreFeature = string> {
    ...
    readonly actions: {
        composeEntityActions: (payload: CompositeEntityActionPayload<TEntityTypeMap, TStoreFeature>, config?: CompositeEntityActionConfig) => ComposedEntityActions<TEntityTypeMap, TStoreFeature>;
    };
