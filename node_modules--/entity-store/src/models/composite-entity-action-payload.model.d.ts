...
export declare type AddEntityActionParamsMap<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = {
    readonly [K in keyof TEntityTypeMap]?: KeyValueStore<TEntityTypeMap[K]>;
};
export declare type UpdateEntityActionParamsMap<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = {
    readonly [K in keyof TEntityTypeMap]?: KeyValueStore<Partial<TEntityTypeMap[K]>>;
};
export declare type SetEntityActionParamsMap<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = {
    readonly [K in keyof TEntityTypeMap]?: KeyValueStore<TEntityTypeMap[K]>;
};
export declare type RemoveEntityActionParamsMap<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = {
    readonly [K in keyof TEntityTypeMap]?: ReadonlyArray<string>;
};
export declare type SelectEntityActionParamsMap<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = {
    readonly [K in keyof TEntityTypeMap]?: ReadonlyArray<string>;
};
export declare type ClearEntityActionParamsList<TEntityTypeMap extends EntityTypeMap, TStoreFeature> = ReadonlyArray<keyof TEntityTypeMap>;
...
export interface CompositeEntityActionPayload<TEntityTypeMap extends EntityTypeMap, TStoreFeature> {
    readonly add?: ReadonlyArray<AddEntityActionParams<TEntityTypeMap, TStoreFeature>> | AddEntityActionParamsMap<TEntityTypeMap, TStoreFeature>;
    readonly update?: ReadonlyArray<UpdateEntityActionParams<TEntityTypeMap, TStoreFeature>> | UpdateEntityActionParamsMap<TEntityTypeMap, TStoreFeature>;
    readonly remove?: ReadonlyArray<RemoveEntityActionParams<TEntityTypeMap, TStoreFeature>> | RemoveEntityActionParamsMap<TEntityTypeMap, TStoreFeature>;
    readonly clear?: ReadonlyArray<ClearEntityActionParams<TEntityTypeMap, TStoreFeature>> | ClearEntityActionParamsList<TEntityTypeMap, TStoreFeature>;
    readonly select?: ReadonlyArray<SelectEntityActionParams<TEntityTypeMap, TStoreFeature>> | SelectEntityActionParamsMap<TEntityTypeMap, TStoreFeature>;
    readonly set?: ReadonlyArray<SetEntityActionParams<TEntityTypeMap, TStoreFeature>> | SetEntityActionParamsMap<TEntityTypeMap, TStoreFeature>;
}
