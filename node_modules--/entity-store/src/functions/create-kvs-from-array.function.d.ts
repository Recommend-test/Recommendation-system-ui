...
export declare type GetIdSignature<TModel> = (x: TModel) => string;
export declare type IdPropertyAccessor<TModel> = string | GetIdSignature<TModel>;
/**
 *
 ...
 *
 */
export declare function createKVSFromArray<TModel>(array: ReadonlyArray<TModel>, idPropertyAccessor?: IdPropertyAccessor<TModel>): KVS<TModel>;
